...
ggplot_3 + geom_point(aes(x = Turbine.Rotor_Diameter, y = Turbine.Capacity), col = "turquoise")+ labs( title = "Graph 1", x = "Diameter of the Turbine's Rotor in Meters (m)" , y = "Turbine Capacity measured in KW (kilo-watts)")
```
